...
with `led_combo`, which splits the 11-LED strip by sensor in **Combo** mode:
...
Six modes are selectable from Home Assistant or the built-in web UI: **Combo**, **CO2**,
**PM2.5**, **VOC**, **Test**, **Off**.

**Updated thresholds** — grounded in published health guidelines rather than the
AirGradient dashboard defaults:
